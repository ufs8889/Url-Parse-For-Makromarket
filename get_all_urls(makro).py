...
import time
start = time.time()
get_data = lambda url: BeautifulSoup(((requests.get(url)).text),"html.parser") # [BeautifulSoup(html, 'html.parser') 
...
#print(with_pagination)
#print(without_pagination)
